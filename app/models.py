...
class Property(db.Model):
    ...
    property_no_bathrooms = db.Column(db.Integer)
    property_price = db.Column(db.Integer)
    property_type = db.Column(db.String(50))
    property_location = db.Column(db.String(100))

    def __init__(self, property_title, property_description, property_no_rooms, property_no_bathrooms, property_price, property_type, property_location):
